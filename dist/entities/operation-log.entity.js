...
__decorate([
    (0, typeorm_1.Column)({ type: 'varchar', length: 50, name: 'target_type', nullable: true }),
    __metadata("design:type", String)
], OperationLog.prototype, "target_type", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: 'int', name: 'target_id', nullable: true }),
    __metadata("design:type", Number)
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => user_entity_1.User, (user) => user.operationLogs),
...
exports.OperationLog = OperationLog = __decorate([
    ...
    (0, typeorm_1.Index)('idx_log_user', ['user_id']),
    (0, typeorm_1.Index)('idx_log_action', ['action'])
], OperationLog);
