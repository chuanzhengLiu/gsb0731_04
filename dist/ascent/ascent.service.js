...
const ascent_rules_1 = require("../common/ascent-rules");
let AscentService = class AscentService {
    ...
    async getAscentCalendar(userId, month) {
        const { startDate, endDate } = (0, ascent_rules_1.getMonthDateRange)(month);
        ...
        for (const ascent of ascents) {
            ...
            if ((0, ascent_rules_1.isSentAscent)(ascent.ascent_type)) {
