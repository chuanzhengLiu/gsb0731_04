...
const verification_rules_1 = require("../common/verification-rules");
let UserService = class UserService {
    ...
    getPendingVerifications(gymId) {
        return this.userRepository.find({
            where: {
                ...
                rejected_at: (0, typeorm_2.IsNull)(),
    ...
    async verifyUser(userId, approved, reason) {
        ...
        (0, verification_rules_1.applyVerificationDecision)(user, approved, reason, user_entity_1.UserRole.VERIFIED_CLIMBER);
